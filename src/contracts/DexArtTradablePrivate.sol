...
/**
 * @title DexArtTradablePrivate
 * DexArtTradablePrivate - ERC1155 contract that whitelists an operator address, 
 * has mint functionality, and supports useful standards from OpenZeppelin,
  like _exists(), name(), symbol(), and totalSupply()
 */
contract DexArtTradablePrivate is
    ERC1155,
    ERC1155MintBurn,
    ERC1155Metadata,
    Ownable
{
    ...
    address marketplace;
    // Dex Bundle Marketplace contract
    ...
    /**
     * Override isApprovedForAll to whitelist Dex contracts to enable gas-less listings.
     */
    ...
    {
        // Whitelist Dex marketplace, bundle marketplace contracts for easy trading.
