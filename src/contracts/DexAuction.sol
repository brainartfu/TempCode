 ...
 */
contract DexAuction is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    using SafeMath for uint256;
    using AddressUpgradeable for address payable;
    using SafeERC20 for IERC20;

    /// @notice Event emitted only on construction. To be used by indexers
    event DexAuctionContractDeployed();
        ...
        initializer
    {
        require(
            ...
            "DexAuction: Invalid Platform Fee Recipient"
        );

        platformFeeRecipient = _platformFeeRecipient;
        emit DexAuctionContractDeployed();
 ...
 */
        ...
        nonReentrant
    {
        ...
        IDexMarketplace marketplace = IDexMarketplace(
        ...
        emit AuctionResulted(
            ...
            winner,
            auction.payToken,
            IDexMarketplace(addressRegistry.marketplace()).getPrice(
                auction.payToken
            ),
            winningBid
        );
