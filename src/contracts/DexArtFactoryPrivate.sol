...
import "./DexArtTradablePrivate.sol";

contract DexArtFactoryPrivate is Ownable {
    /// @dev Events of the contract
    event ContractCreated(address creator, address nft);
    event ContractDisabled(address caller, address nft);

    /// @notice Dex marketplace contract address;
    address public marketplace;

    /// @notice Dex bundle marketplace contract address;
    ...
    */
    ...
    /// @notice Method for deploy new DexArtTradablePrivate contract
        ...
        returns (address)
    {
        ...
        DexArtTradablePrivate nft = new DexArtTradablePrivate(
            _name,
            _symbol,
            mintFee,
            feeRecipient,
    ...
    /// @notice Method for registering existing DexArtTradable contract
    ...
    /// @notice Method for disabling existing DexArtTradable contract
    /// @param  tokenContractAddress Address of NFT contract
